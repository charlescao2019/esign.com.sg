...
<template>
  <div class="d-flex justify-center desktop-view">
    <template
    ...
    >
      ...
      >
        ...
        <template v-if="item.icon">
          <div class="stepper-icon-step text-high-emphasis d-flex align-center mx-5">
            <!-- 👉 icon and title -->
            <div
              class="d-flex align-center gap-x-3 step-wrapper"
              :class="[props.direction === 'horizontal' && 'flex-column', currentStep === index ? 'active-stepper-border' : '']"
            >
              ...
              <div>
                <p class="text-h5 stepper-title mb-0">
                  {{ item.title }}
                </p>
                <p
                  v-if="item.subtitle"
...
<!--            />-->
  ...
  <div class="d-flex justify-center mobile-view">
    <template
      v-for="(item, index) in props.items"
      :key="item.title"
    >
        ...
        <template v-if="item.icon">
          <div class="stepper-icon-step text-high-emphasis d-flex align-center ">
            ...
            >
              ...
              <div>
                <p class="stepper-mobile-title mb-0 mx-2">
                  {{ item.title }}
                </p>
                <p
                  v-if="item.subtitle"
...
<!--            &lt;!&ndash; 👉 append chevron &ndash;&gt;-->
<!--            <VIcon-->
<!--              v-if="isHorizontalAndNotLastStep(index)"-->
<!--              class="flip-in-rtl stepper-chevron-indicator mx-2"-->
<!--              size="20"-->
<!--              icon="tabler-chevron-right"-->
<!--            />-->
          </div>
